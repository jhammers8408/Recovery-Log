...
<p style={{ color: '#4a6080', fontSize: '14px' }}>What actually improves YOUR performance.</p>
  ...
  style={{ backgroundColor: '#111820', border: '1px solid #1e2a3a', borderRadius: '12px', padding: '13px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', cursor: 'pointer' }}>
